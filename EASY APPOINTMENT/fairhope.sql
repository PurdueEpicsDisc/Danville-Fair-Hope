...
--
-- Host: localhost:8889
-- Generation Time: Nov 06, 2014 at 04:46 PM
...
INSERT INTO `ea_users` (`id`, `first_name`, `last_name`, `email`, `mobile_number`, `phone_number`, `address`, `city`, `state`, `zip_code`, `notes`, `id_roles`, `num_of_children`, `no_show_flag`) VALUES
(84, 'Root', 'User', 'aharon@aharonhannan.com', '', '1234567890', '', '', '', '', '', 1, 0, 0),
(85, 'Fair Hope', 'Children''s Ministry', 'null@null.com', '', '1234567890', '', '', '', '', '', 2, 0, 0);
